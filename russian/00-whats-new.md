...
В программном обеспечении «Центр охраны» версии 4 есть целый ряд новинок, позволяющих охранному предприятию не только увеличить список предоставляемых клиентам услуг, но и оптимизировать работу операторской и инженерной службы. 
...
Для того чтобы оператор «Центра охраны» мог оповестить ответственных о перезакрытии объекта, должны быть разрешены такие типы действия, как «Требуется перезакрытие» и «Отказ от перезакрытия». Необходимые настройки можно задать в модуле «Настройки системы» на вкладке [«Действия»](#sistem-setup-actions).
...
Важной особенностью приложения «MyAlarm» является возможность просмотра журнала событий по объекту. При этом, если на объекте установлена контрольная панель «MyAlarm», то в журнале событий доступны фотоподтверждения тревог, которые формирует эта контрольная панель. А если на объекте установлен видеороутер, то в журнале событий можно просмотреть видеоподтверждения тревог: небольшие видеоролики, на которых фиксируется промежуток времени за несколько секунд до тревоги и несколько секунд после.
