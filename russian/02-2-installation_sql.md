...
5. Необходимо убедиться что служба SQL browser установлена и запущена в автоматическом режиме.
6. Зайти в диспетчер конфигурации SQL и проверить что включены TCP/ UDP/ Named channel.
