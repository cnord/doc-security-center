...
\imgcapt{img/Setup-Full-02.png}{Полная установка: выбор необходимости установки BDE}
...
\imgcapt{img/Setup-Full-03.png}{Полная установка: перечень настроек программы установки}
