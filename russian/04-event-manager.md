...
*Обработчик событий, настроенный так, как показано на рисунке, будет контролировать приход класса события «Контроль связи» каждые 30 минут. Допустимым для получения следующего события будет считаться период от 25 до 34 минут после  класс*
