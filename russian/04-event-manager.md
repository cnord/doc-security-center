...
С помощью кнопки «Добавить...» можно создать новое задание резервного копироания, а кнопки «Изменить...» и «Удалить» предназначены для изменения параметров существующего задания или его удаления.

При создании нового задания резервного копирования или изменении существующего параметры задания можно опеределить в окне «Задание резервного копирования». 
