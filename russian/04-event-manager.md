...
Полная интеграция с Облаком позволяет использовать удаленный доступ к оборудованию на объекте, а также все облачные сервисы («Call-центр», «Тревога в ГБР», «Личный кабинет», «Ситуационная карта»и др.). При этом все данные об объектах, события и действия операторов будут передаваться в Облако.
...
Доступ к регистрационной информации и UID Центра охраны будет невозможен. 
