...
Обработчик событий «Ретранслятор в ПАК ВсМК (Росгвардия)» предназначен для ретрансляции информации о событиях в ПАК ВсМК Росгвардии. Для работы обработчика необходимы учётные данные для доступа к ПАК ВсМК, а также настроенные идентификаторы объектов на вкладке «Росгвардия» в Менеджере объектов.
