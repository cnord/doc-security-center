...
Обработчик событий может отправлять SMS-сообщения с помощью одного из устройств, подключаемых непосредственно к компьютеру, на котором он функционироует:
* GSM-модем SonyEriccson GM-22
* GSM-модем SonyEriccson GR-47
* GSM-терминалы на базе GSM-модема Siemens MC35 или совместимого
...
Настройки на вкладке «Устройство» позволяют определить способ, с помощью которого будет выполнятся отправка SMS-сообщений.

![Окно «Параметры группы (Ретранслятор SMS)», вкладка «Устройство», параметры устройства «Трасивер SMS через модем GR-47»][id-04-34]


Как написано выше, обработчик событий «Ретранслятор SMS» поз
...
[id-04-34]: img/Eventhandler-02-02.png "Окно «Параметры группы (Ретранслятор SMS)», вкладка «Устройство», параметры устройства «Трасивер SMS через модем GR-47»"
[id-04-]: img/.png "«»"
