...
Фильтрацию тестовых событий можно отключить с помощью одноименного параметра. При включенной фильтрации тестовые события обрабатываются так же, как и повторные: они не отображаются в общем списке принятых событий в модуле «Дежурный оператор» и не включаются в отчетах по событиям, если это специально не указано. 
