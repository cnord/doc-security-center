...
Источник событий с возможностью изменения протокола обмена и транспортного протокола. Может принимать события по следующим протоколам:

* LLR8000

Источник событий может работать по следующим транспортным протоколам (Каналам подключения):

* TCP/IP
* COM порт

\imgcapt{img/EventSource-15-03.png}{Окно свойств источника событий «Универсального источника событий»}
