...
Если обработчик событий необходимо настроить таким образом, чтобы обработка событий выполнялась только в заданное время, то задать расписание работы обработчика можно на вкладке «Расписание».
