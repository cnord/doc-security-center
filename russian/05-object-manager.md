...
Для удаления введенных координат объекта с карты необходимо кликнуть по кнопке "Удалить с карты" и затем подтвердить удаление. При этом информация о координатах объекта будет удалена как из Облака, так и из базы данных "Центра охраны".
