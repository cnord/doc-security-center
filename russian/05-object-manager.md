...
Вкладка «Видеороутеры» в модуле «Менеджер объектов» позволяет пользователю, наделенному правом «Изменять информацию о видеороутерах», добавить для объекта видеороутеры, к которым подключены видеокамеры, установленные на объекте. Благодаря этому возможно удаленное наблюдение за объектом ответственным лицом охраняемого предприятия, а также - дежурным оператором охранного предприятия при отработке тревоги.

![Вкладка «Видеороутеры»][id-05-16]

Чтобы добавить установленный на объекте видеороутер, необходимо нажать на кнопку «Добавить видеороутер» на вкладке «Видеороутеры». В поле «№ роутера» следует ввести идентификационный номер роутера, а в поле «Ключ» - пароль для авторизации роутера, указанные на устройстве. После ввода данных нужно нажать кнопку «Сохранить» для сохранения информации о видеороутере или кнопку «Отмена» для отмены сохранения. Значок текущего состояния видеороутера отображает статус его подключения. При этом данные о конфигурации роутера, а именно - описание каждой из подключенных к нему видеокамер и номера шлейфов, попадающих в поле зрения видеокамер, отображаются в карточке объекта. Эта информация сохраняется в базе данных «Центра Охраны» и в «Облаке». 
