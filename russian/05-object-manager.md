...
### «ТР-100 GSM III / Союз GSM»

При использовании на объекте контрольной панели производства фирмы «Си-Норд» или «PIMA Electronic Systems Ltd.» с коммуникатором «ТР-100 GSM III» или передатчиком «Союз GSM» из представленного списка типов оборудования следует выбрать «ТР-100 GSM III / Союз GSM». 

Подключение этой системы не требует дополнительной настройки на вкладке «Оборудование»: в поле «Идентификатор» автоматически определяется идентификатор коммуникатора, установленного на объекте.

Идентификатор коммуникатора - это уникальный идентификационный номер его процессора. Программирование устройства позволяет закрепить за его идентификатором один или несколько объектов.

При замене передатчика, подключенного к контрольной панели на объекте, значение параметра «Идентификатор» следует удалить. Сделать это можно с помощью кнопки «Удалить», расположенной напротив поля «Идентификатор». После удаления прежнего значения идентификатор нового передатчика автоматически определится в поле «Идентификатор».
