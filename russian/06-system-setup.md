...
\imgcapt{img/syssetup-03.png}{Вкладка «Классы событий»}
...
\imgcapt{img/syssetup-03-01.png}{Окно «Замена класса события»}
...
\imgcapt{img/syssetup-01.png}{Вкладка «Шаблоны событий»}
...
\imgcapt{img/syssetup-01-01.png}{Окно «Замена шаблона событий»}
...
\imgcapt{img/syssetup-01-02.png}{Окно «Изменить событие»}
...
\imgcapt{img/syssetup-04.png}{Вкладка «Действия»}
...
\imgcapt{img/syssetup-05.png}{Вкладка «Отмены тревог»}
...
\imgcapt{img/syssetup-02.png}{Вкладка «Типы объектов»}
...
\imgcapt{img/syssetup-06.png}{Вкладка «Поля объектов»}
