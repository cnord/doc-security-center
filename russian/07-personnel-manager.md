...
Для удаления администратора «Личного кабинета» необходимо выделить его в списке, нажать кнопку «Удалить» и подтвердить удаление. Если администратор зарегистрирован в «Личном кабинете», его учетная запись удаляется из «Облака». 
