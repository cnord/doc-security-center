...
\imgcapt{img/empman-01.png}{Вкладка «Операторы»}
...
\imgcapt{img/empman-01-00.png}{Выбор списка прав для нового оператора}
...
\imgcapt{img/empman-01-01.png}{Права оператора в модуле «Менеджер событий»}
...
\imgcapt{img/empman-01-02.png}{Права оператора в модуле «Дежурный оператор»}
...
\imgcapt{img/empman-01-03.png}{Права оператора в модуле «Менеджер объектов»}
...
\imgcapt{img/empman-01-04.png}{Права оператора в модуле «Менеджер отчетов»}
...
\imgcapt{img/empman-01-05.png}{Права оператора в модуле «Карты объектов»}
...
\imgcapt{img/empman-01-06.png}{Права оператора в модуле «Настройка системы»}
...
\imgcapt{img/empman-01-07.png}{Права оператора в модуле «Конфигуратор ключей Норд-LAN»}
...
\imgcapt{img/empman-01-08.png}{Права оператора в модуле «Менеджер персонала»}
...
\imgcapt{img/empman-02.png}{Вкладка «Группы быстрого реагирования»}
...
\imgcapt{img/empman-03.png}{Вкладка «Компьютеры»}
...
\imgcapt{img/empman-04.png}{Вкладка «Инженеры»}
...
\imgcapt{img/empman-04-00.png}{Добавление инженера}
