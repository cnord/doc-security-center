...
* «Код», «Класс события», «Раздел», «Ш/П», «Описание» - параметры, полученные от объекта, либо в результате расшифровки события в соответствии с описанием объекта. Подробнее о значении этих можно узнать в главах, посвященных модулям «Настройка системы» и «Менеджер объектов», в разделах, описывающих шаблоны событий.
...
На вкладке «Тревоги» отображаются тревожные события, отработка которых еще не завершена. Так же, как и на вкладке «Все события», здесь отображаются только значимые события.
...
[id-09-05]: img/ShiftOp-Main-Toolbar-01.png "Панель управления"
