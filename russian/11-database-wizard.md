...
На стартовом экране модуля «Мастер базы данных», который отображается после запуска модуля, нужно выбрать необходимую операцию

![Стартовый экран модуля «Мастер базы данных»][id-11-01]

## Проверка базы данных

Операцию проверки базы данных рекомендуется выполнять не реже, чем раз в месяц. Процедуры, входящие в операцию проверки базы, не имеют никаких настроек и выполняются автоматически. При выполнении проверки базы данных работу остальных модулей можно не прекращать. После завершения проверки рекомендуется перезапустить модуль «Дежурный оператор».
...
![Экран настройки операции резервного копирования][id-11-02]

При создании резервной копии базы данных нужно выбрать объем информации, которая будет включена в резервную копию. 
...
![Экран настроек операции восстановления из резервной копии][id-11-03]
...
![Экран выбора источника данных для операции импорта][id-11-04]
...
![Экран настроек операции импорта из базы данных программного обеспечения «Андромеда»][id-11-05]
...
![Экран настроек операции импорта из базы данных программного обеспечения «Страж»][id-11-06]
...
![Экран настроек операции импорта из базы данных программного обеспечения «CSM32»][id-11-07]
...
![Экран настройки соответствия классов событий при импорте из базы данных программного обеспечения «CSM32»][id-11-08]
...
![Экран выбора объектов и полей при настройке операции экспорта информации об объектах][id-11-09]

При выполнении экспорта необходимо выбрать объекты и поля (столбцы), информация о которых будет записана в файл экспорта.

![Экран настройки операции экспорта информации об объектах][id-11-10]
...
[id-11-01]: img/AnDBWiz-01.png "Стартовое окно модуля «Мастер базы данных»"
[id-11-02]: img/AnDBWiz-01.png "Экран настройки операции резервного копирования"
[id-11-03]: img/AnDBWiz-01.png "Экран настроек операции восстановления из резервной копии"
[id-11-04]: img/AnDBWiz-01.png "Экран выбора источника данных для операции импорта"
[id-11-05]: img/AnDBWiz-01.png "Экран настроек операции импорта из базы данных программного обеспечения «Андромеда»"
[id-11-06]: img/AnDBWiz-01.png "Экран настроек операции импорта из базы данных программного обеспечения «Страж»"
[id-11-07]: img/AnDBWiz-01.png "Экран настроек операции импорта из базы данных программного обеспечения «CSM32»"
[id-11-08]: img/AnDBWiz-01.png "Экран настройки соответствия классов событий при импорте из базы данных программного обеспечения «CSM32»"
[id-11-09]: img/AnDBWiz-01.png "Экран выбора объектов и полей при настройке операции экспорта информации об объектах"
[id-11-10]: img/AnDBWiz-01.png "Экран настройки операции экспорта информации об объектах"
