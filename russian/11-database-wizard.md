...
Выбор объектов, информация о которых должна быть экспортирова, осуществляется установкой флага («галочки») в первой колонке строки с объектом.
...
[id-11-08]: img/AnDBWiz-01.png "Окно настройки соответствия классов событий при импорте из базы данных программного обеспечения «CSM32»"
...
[id-11-10]: img/AnDBWiz-EI-Exp-Csv-02.png "Окно настройки операции экспорта информации об объектах"
