...
Например, посредством Облака предоставляются услуги автоматизированного Call-центра. С его помощью можно узнать о текущем состоянии объекта (взят или снят), а также проверить кнопку тревожной сигнализации (КТС), не обращаясь к оператору.
...
С помощью панели управления учетной записи партнера необходимо настроить услуги «Call-центра». А именно: подтверждение снятий и взятий под охрану; проверка КТС.
