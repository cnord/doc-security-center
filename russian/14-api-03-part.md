...
PartNumber & number & Номер раздела (обязательный, почти всегда совпадает с номером раздела контрольной панели, установленной на объекте) \\ \arrayrulecolor{light-gray}\hline
