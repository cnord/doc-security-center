...
Interval & number & Время в миллисекундах, на которое замыкается коллектор в случае, если параметр «Action» принимает значение «pulse», допустимые значения от 1 до 10000. \\
