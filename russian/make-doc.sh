...
pandoc --template template/template.latex -V title-source=title-http-api.tex -o sc5-http-api-rus.pdf 14-api-01-intro.md 14-api-02-object.md 14-api-03-part.md 14-api-07-checkpanic.md
