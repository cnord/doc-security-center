...
* На компьютере с модулем «Менеджер объектов» должен быть открыт 443 порт в интернет.
...
* Ввести номер видеороутера и ключ для подключения к нему.
* Сохранить изменения.
...
* Ввести идентификационный номер «Частного Облака», к которому должен подключаться видеороутер
