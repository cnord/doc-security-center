...
`Нужна картинка, на которой выделен значок корзины`
...
`Нужна картинка, на которой видно, что все плохо`
...
`Нужно описать видеоподтверждения подробнее, добавить картинку из приложения MyAlarm. Кроме того, нужно написать, что камера, которая смотрит на тревожный шлейф, выделяется, когда оператор смотрит видео`
